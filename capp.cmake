...
macro(capp_app)
  ...
  set(CAPP_CONFIGURATION_FILE "${capp_app_CONFIGURATION_FILE}")
  if (CAPP_CONFIGURATION_FILE)
    if (NOT IS_ABSOLUTE CAPP_CONFIGURATION_FILE)
      set(CAPP_CONFIGURATION_FILE "${CAPP_ROOT}/${CAPP_CONFIGURATION_FILE}")
    endif()
    if (EXISTS "${CAPP_CONFIGURATION_FILE}")
      include("${CAPP_CONFIGURATION_FILE}")
    else()
      message(FATAL_ERROR "The configuration file ${CAPP_CONFIGURATION_FILE} does not exist.")
    endif()
  endif()
endmacro()
