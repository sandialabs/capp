...
function(capp_build_install)
  ...
  message("capp_install_result=${capp_install_result}")
  if (capp_install_result EQUAL 0)
    message("setting ${capp_build_install_PACKAGE}_IS_INSTALLED=TRUE")
    set(${capp_build_install_PACKAGE}_IS_INSTALLED TRUE PARENT_SCOPE)
    message("writing ${CAPP_INSTALL_ROOT}/${capp_build_install_PACKAGE}/capp_installed.txt")
...
function(capp_initialize_needs)
  ...
  endforeach()
  set(reverse_package_list "${CAPP_PACKAGES}")
  list(REVERSE reverse_package_list)
  foreach(package IN LISTS reverse_package_list)
